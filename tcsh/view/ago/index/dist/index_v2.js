define(function (require, exports, module) {
    ...
    var bind = function () {
        ...
        $class_nav.find(".ci_hoverkey").hover(function () {
            ...
            if (_negative < 0) {
                $sub_class.stop().css({ "top": parseFloat($sub_class.css("top")) + _negative - 20 });
            }
            _negative = $sub_class.offset().top - $this.closest(".con_row").offset().top;
            if (_negative < 0) {
                $sub_class.stop().animate({ "top":  - 20 });
            }
        }, function () {
            var $this = $(this);
