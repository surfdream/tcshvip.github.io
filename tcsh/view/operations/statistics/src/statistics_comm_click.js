define(function (require, exports, module) {
    ...
    var init = function () {
        ...
        for (var i in global_setting.series) {
            categories.push('<a href="' + domains.item + '/' + global_setting.series[i].productId + '.html">' + global_setting.series[i].productname + '</a>');
        ...
        $('.statistics_box').highcharts({
            ...
            tooltip: {
                pointFormat: '商品被浏览了: <b>{point.y} 次</b>',
            },
            series: [{
                name: 'Population',
                data: series,
