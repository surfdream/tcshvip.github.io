define(function(require,exports,module){
	...
	var init = function(){
		...
		/*分页*/
		if (global_setting && global_setting.page && global_setting.page.total) {
			var _page = page.Create({
				element:".order_page",
				url: global_setting.page.url || "",
				index: (global_setting.page.page) || 1,
				size: (global_setting.page.size) || 10,
				sum: (global_setting.page.total) || 0,
				param:$.extend({
					total:global_setting.page.total
				},global_setting.page.param),
				pagekey: "page",
				front: true
			});
		}
